package com.sdjic.gradnet.presentation.composables.animatedlist
...
import androidx.compose.ui.unit.dp
import com.sdjic.gradnet.presentation.core.model.AnimationProgress
import com.sdjic.gradnet.presentation.theme.ActiveColor
import com.sdjic.gradnet.presentation.theme.InactiveColor
import network.chaintech.kmp_date_time_picker.ui.datepicker.ExperimentalSnapperApi
import network.chaintech.kmp_date_time_picker.ui.datepicker.SnapOffsets
import network.chaintech.kmp_date_time_picker.ui.datepicker.SnapperLayoutInfo
import network.chaintech.kmp_date_time_picker.ui.datepicker.SnapperLayoutItemInfo
...
private fun calculateScale(
    ...
    return if (distanceToSelector < scaleRegionSize) {
        ...
        com.sdjic.gradnet.presentation.core.lerp(start = minimum, stop = 1f, fraction = fraction)
    } else {
        minimum
